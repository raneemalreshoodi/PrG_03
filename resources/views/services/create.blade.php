...
<html lang="ar">
  ...
  <body>
    <div class="bg-dark py-3">
        <h3 class="text-white text-center">إضافة خدمة</h3>
    </div>
    <div class="container">
            ...
            <div class="col-md-10">
                <div class="card border-0 shadow-lg my-4">
                    <div class="card-header bg-dark">
                        <h3 class="text-white">إضافة خدمة</h3>
                    </div>
                    <form enctype="multipart/form-data" action="{{ route('services.store') }}" method="POST">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input value="{{ old('title') }}" type="text" class="@error('title') is-invalid @enderror form-control form-control-lg" placeholder="العنوان" name="title">
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea placeholder="الوصف" class="form-control-lg form-control" name="desc" cols="30" rows="5">{{ old('desc') }}</textarea>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="d-grid">
                                <button class="btn btn-lg btn-primary">إرسال</button>
                            </div>  
                        </div>
                    </form>
                </div>
